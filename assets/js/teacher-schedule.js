...
function renderUpcomingList() {
  ...
  upcomingList = bookings
    ...
    .sort((a, b) => {
      ...
      const tb = new Date(
        `${b.dateStr}T${String(b.hour).padStart(2, "00")}:00:00`,
      );
      return ta - tb;
    });

  document.getElementById("upcoming-count").textContent =
    `${upcomingList.length} 筆`;
...
function enterEditMode() {
  ...
  document
    .getElementById("btn-save-schedule")
...
function cancelEdit() {
  ...
  document.getElementById("schedule-btn-group").innerHTML = `
    ...
    `;
  document
    .getElementById("btn-edit-schedule")
